"""
Interpret route-intersection output and safe navigation waypoints produced by GIS & Route engines.
"""
...
def assess_route(gis_result: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        "summary": f"Route intersects {count} supplied zone feature(s).",
        "risk_score": 0.7 if count else 0.0,
